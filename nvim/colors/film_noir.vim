...
if s:main_color == 'red'
    if has('gui_running') || &t_Co == 256
        ...
        hi Normal cterm=NONE ctermfg=250 ctermbg=235 gui=NONE guifg=#bcbcbc guibg=#212933
...
if s:main_color == 'green'
    if has('gui_running') || &t_Co == 256
        hi String cterm=NONE ctermfg=46 ctermbg=16 gui=NONE guifg=#f2a05a guibg=#212933
        hi Comment cterm=NONE ctermfg=22 ctermbg=16 gui=NONE guifg=#f2a05a guibg=#212933
        hi Number cterm=NONE ctermfg=46 ctermbg=16 gui=NONE guifg=#f2a05a guibg=#212933
        hi Error cterm=NONE ctermfg=255 ctermbg=22 gui=NONE guifg=#f2a05a guibg=#669d33
        hi ErrorMsg cterm=NONE ctermfg=255 ctermbg=34 gui=NONE guifg=#f2a05a guibg=#7cc13f
        hi DiffChange cterm=NONE ctermfg=22 ctermbg=255 gui=NONE guifg=#669d33 guibg=#eeeeee
        hi DiffText cterm=bold ctermfg=255 ctermbg=22 gui=bold guifg=#f2a05a guibg=#669d33
        hi SignColumn cterm=NONE ctermfg=46 ctermbg=240 gui=NONE guifg=#9fff54 guibg=#585858
        hi SpellBad cterm=undercurl ctermfg=255 ctermbg=22 gui=undercurl guifg=#f2a05a guibg=#669d33
        ...
        hi Normal cterm=NONE ctermfg=250 ctermbg=16 gui=NONE guifg=#bcbcbc guibg=#212933
        hi Keyword cterm=NONE ctermfg=255 ctermbg=16 gui=NONE guifg=#eeeeee guibg=#212933
        hi Constant cterm=NONE ctermfg=252 ctermbg=16 gui=NONE guifg=#d0d0d0 guibg=#212933
        hi Search cterm=NONE ctermfg=245 ctermbg=236 gui=NONE guifg=#8a8a8a guibg=#303030
        hi IncSearch cterm=reverse ctermfg=255 ctermbg=245 gui=reverse guifg=#eeeeee guibg=#8a8a8a
        hi WildMenu cterm=NONE ctermfg=240 ctermbg=255 gui=NONE guifg=#585858 guibg=#eeeeee
        hi Pmenu cterm=NONE ctermfg=255 ctermbg=240 gui=NONE guifg=#eeeeee guibg=#585858
        ...
        hi CursorLine cterm=NONE ctermfg=NONE ctermbg=233 gui=NONE guifg=NONE guibg=#121212
        hi StatusLine cterm=bold,reverse ctermfg=245 ctermbg=16 gui=bold,reverse guifg=#8a8a8a guibg=#000000
        hi StatusLineNC cterm=reverse ctermfg=236 ctermbg=16 gui=reverse guifg=#303030 guibg=#212933
        hi Visual cterm=reverse ctermfg=250 ctermbg=16 gui=reverse guifg=#bcbcbc guibg=#212933
        hi TermCursor cterm=reverse ctermfg=NONE ctermbg=NONE gui=reverse guifg=NONE guibg=NONE
    else
        ...
        hi Normal cterm=NONE ctermfg=Grey ctermbg=Black guibg=#212933
        hi Keyword cterm=NONE ctermfg=White ctermbg=Black
        hi Constant cterm=NONE ctermfg=Grey ctermbg=Black
        hi Search cterm=NONE ctermfg=Grey ctermbg=DarkGrey
        hi IncSearch cterm=reverse ctermfg=White ctermbg=Grey
